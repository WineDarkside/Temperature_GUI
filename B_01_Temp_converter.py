...
class Converter():
    ...
    def check_temp(self, min_temp):
        """
        Checks temp is valid and either invokes calculation
        ...
        # reset label and entry box (if ew had an error)
    ...
    def to_help(self):
        ...
        (so that users can't create multiple help boxs)
        """
        DisplayHelp(self)
...
class DisplayHelp:
    def __init__(self, partner):
        ...
        help_text = "To use the program, simply enter the temperature" \
                    " you wish to convert ans then choose to convert" \
                    ...
                    "To see your " \
                    "calculation history and export it to a text file," \
...
class HistoryExport:
    ...
    def __init__(self, partner, calculations):
        ...
        recent_intro_txt = (f"Below are {calc_amount} calculations"
                            "(to the nearst degree).")

        # Create string from calculations list (newest calculations first)
        newest_first_string = ""
        newest_first_list = list(reversed(calculations))

        # last item in outside teh for loop so that the spacing is correct
    ...
    def export_data(self, calculations):
        ...
        with open(write_to, "w") as text_file:
            ...
            text_file.write("Here is you calculation history (oldest to newest)...\n")
